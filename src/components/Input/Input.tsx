...
interface Props<TFieldValues extends FieldValues> extends InputHTMLAttributes<HTMLElement> {
...
export default function Input<TFieldValues extends FieldValues = FieldValues>({
    ...
    return (
        <div className={rest.type === 'password' ? className + ' relative' : className}>
            <input className={classNameInput} {...registerResult} {...rest} type={handleType()} />
            {rest.type === 'password' && visibility && (
                <svg
